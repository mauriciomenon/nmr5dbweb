// app.js
// Logica principal da aba "Busca" (painel DuckDB):
// - controla fluxo Selecionar DB -> Converter -> Indexar -> Buscar
// - gerencia uploads/selecoes/abas de DB e tabelas
// - conversa com os endpoints /admin/* e /api/*.
...
window.addEventListener('unhandledrejection', (e)=>{
  ...
  function updatePrimaryHint(status, showHint){
    ...
    if(status.indexing){
      setFlowHint('Indexacao em andamento. Busca liberada ao terminar.', shouldShow);
      return;
    }
...
function exportResultsCsv(){
  ...
  // startup inicial antigo (duplicado abaixo em versao mais nova)
  // Mantido apenas para compatibilidade; nao registra nada extra.
